...
export function loadGame(): GameState {
  ...
  try {
    ...
    const migrated: GameState = {
      ...
      competitorHistory: parsed.competitorHistory ?? [],
      ...
      cooNetworkPolicy: { ...base.cooNetworkPolicy, ...(parsed.cooNetworkPolicy ?? {}) },
...
export function restoreCheckpoint(): GameState | null {
  try {
    ...
    const restored = refreshDerivedEconomics(repairCampaignState({
      ...
      competitorHistory: state.competitorHistory ?? [],
      cooNetworkPolicy: { ...base.cooNetworkPolicy, ...(state.cooNetworkPolicy ?? {}) },
